#!/usr/bin/python3
"""Contains unit tests for the city module in the models directory."""
...
class TestCity(unittest.TestCase):
    """Test suite for evaluating the functionality of the City class."""
    ...
    def test_str_representation(self):
        ...
        str_representation = self.city.__str__()
        self.assertIn("[City] ({})".format(self.city.id), str_representation)
        self.assertIn("'id': '{}'".format(self.city.id), str_representation)
        self.assertIn("'created_at': {}".format(repr(self.city.created_at)), str_representation)
        self.assertIn("'updated_at': {}".format(repr(self.city.updated_at)), str_representation)
        self.assertIn("'name': '{}'".format(self.city.name), str_representation)
        self.assertIn("'state_id': '{}'".format(self.city.state_id), str_representation)
    ...
    def test_save_filestorage(self):
        ...
        self.city.save()
        self.assertLess(old_updated_at, self.city.updated_at)
        with open("file.json", "r") as file_content:
            self.assertIn("City.{}".format(self.city.id), file_content.read())
